...
| SEND_DIFF_REPORT_TELEGRAM | bool/str | Send open ports changes (new open ports) report to Telegram. | False | | `true` |
...
# with telegram notifications, send only if there are open port changes (new open ports)
